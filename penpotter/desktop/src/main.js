...
function resolveInstance() {
  if (process.env.PENPOTTER_URL) {
    return { key: 'custom', label: 'Custom', url: process.env.PENPOTTER_URL };
  }
  const key = process.env.PENPOTTER_INSTANCE
    || store.read().instance
    || DEFAULT_INSTANCE;
