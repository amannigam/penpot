...
#
#   penpotter/scripts/reset-test-users.sh            # dry run: list what would go
#   penpotter/scripts/reset-test-users.sh --yes      # actually delete
#   KEEP="a@x.com,b@y.com" penpotter/scripts/reset-test-users.sh --yes
#
