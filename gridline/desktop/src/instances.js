...
//
// Override at runtime with GRIDLINE_URL, or pick a named one with
// GRIDLINE_INSTANCE=dev. The choice is remembered between launches.
...
function partitionFor(url) {
  ...
  return `persist:gridline-${host.replace(/[^a-z0-9]/gi, '-')}`;
}
